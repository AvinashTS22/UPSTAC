...
class ConsultationControllerTest {
    ...
    public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status(){
        ...
        TestRequest responseObj = consultationController.assignForConsultation(testRequest.getRequestId());
        ...
        assertThat(testRequest.getRequestId(), is(responseObj.getRequestId()));

        //Assertions.assertEquals(responseObj.getRequestId(), testRequest.getRequestId());
        //assertThat(responseObj.getStatus().toString(), is(RequestStatus.DIAGNOSIS_IN_PROCESS.toString()));
        assertNotNull(responseObj.getConsultation());
